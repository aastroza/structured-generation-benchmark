...
def main():
    prompts = ["Amiri, a 53 year old warrior woman with a sword and leather armor.",
               "Alonso, a 38 year old warrior man with a axe and golden armor."]
    for character in generate.map(prompts):
        print(character)